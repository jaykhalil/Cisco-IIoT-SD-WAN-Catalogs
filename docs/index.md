...
<table>
  <tr>
    <td>
      ...
      <p>Use the interactive selector to choose Catalyst SD-WAN or Catalyst SD-Routing and map your deployment to the closest published Cisco IIoT catalog in this repository.</p>
      <p>
