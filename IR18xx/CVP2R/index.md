...
Single router SD-WAN configuration with wired and single LTE as last resort supporting single service VPN for for horizontal IR1800 deployments.

## Downloads

- [Configuration package](./CVP2R-export-2025-05-06T18_54_22.tar.gz)
- [Catalog guide PDF](./CVP2R_IR1800_Wired_LTE_Backup_Routed.pdf)
