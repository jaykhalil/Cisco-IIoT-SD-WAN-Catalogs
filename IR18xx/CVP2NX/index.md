...
Single router SD-WAN configuration with LTE and wired as last resort supporting single service VPN for for horizontal IR deployments. Reverse priority of CVP1N and CVP2N

## Downloads

- [Configuration package](./CVP2NX-export-2025-07-31T16_33_13.tar.gz)
- [Catalog guide PDF](./CVP2NX_IR1800_LTE_Wired_Backup_NAT.pdf)

## Summary

- Platform: IR1800
- WAN preference: Primary Cellular, wired backup
- Traffic model: DIA / NAT

## Related Pages

- [Catalog Selector](../../catalog-selector.html)
