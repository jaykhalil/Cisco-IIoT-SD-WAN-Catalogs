...
Single router SD-WAN configuration with wired and single LTE as last resort supporting single service VPN for for horizontal IR1101 deployments.

## Downloads

- [Configuration package](./CVP1R-export-2025-05-06T15_23_02.tar.gz)
- [Catalog guide PDF](./CVP1R_IR1101_Wired_LTE_Backup_Routed.pdf)

## Summary

- Platform: IR1101
- WAN preference: Primary Ethernet, LTE backup
- Traffic model: Routed to Enterprise
