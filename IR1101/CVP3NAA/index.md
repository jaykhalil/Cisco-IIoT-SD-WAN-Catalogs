...
Single router SD-WAN configuration with wired and dual LTE in both active/active and active/standby modes, supporting single service VPN for for horizontal IR deployments.

## Downloads

- [Configuration package](./CVP3NAA-export-2025-08-05T17_54_15.tar.gz)
- [Catalog guide PDF](./CVP3NAA_IR1101_Dual_LTE_Active_Active.pdf)

## Summary

- Platform: IR1101
- LTE design: Dual LTE
- Operating mode: Active/Active
